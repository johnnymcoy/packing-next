import CSS from './SideButton.module.css';
...
export default function SideButton(props){
    ...
    const linksClasses = bIsHightlighed ? `${CSS.links} ${CSS.linksSelected}` : `${CSS.links}`;
    function highlightHandler(){
        setbIsHightlighed(prevState => !prevState);
    }

    return(
<li >
    <div className={CSS.title} onClick={highlightHandler}>
        ...
        <span className={CSS.titleText}>{props.title}</span>
